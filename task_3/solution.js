function renderCartItem(item) {
    ...
    // например, {id: 1, title: 'Пицца', count: 5, price: '500.00'}, где id - идентификатор, title - наименование, price - цена, count - количество

    // сформируйте строку itemCountText вида: количество × цена ₽ = стоимость ₽,  например, 5 × 500.00 ₽ = 2500 ₽
