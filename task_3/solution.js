function renderCartItem(item) {
    ...
    pruduct = {id: id, title: title, count: count, price: price}; // product - объект вида {id: id, title: title, count: count, price: price}
    ...
    itemCountText // сформируйте строку itemCountText вида:
